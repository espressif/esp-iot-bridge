...
ESP-IoT-Bridge 方案主要是针对 IoT 应用场景实现的各种网络接口之间的连接与通信，如 SPI、SDIO、USB、Wi-Fi、以太网等网络接口之间的相互连接，并可结合其他方案形成更复杂的应用场景，如 Wi-Fi Mesh Lite、Rainmaker 等。本方案广泛应用于无线热点、无线网卡、有线网卡、4G 上网等多种领域，更多方案介绍可参见 [User_Guide_CN.md](components/iot_bridge/User_Guide_CN.md)。
...
- [examples/iperf/ethernet_wireless_nic](examples/iperf/ethernet_wireless_nic)：ESP-IoT-Bridge 设备通过以太网网口接入 PC，并通过 Wi-Fi 路由器接入网络，通过路由器与 PC 进行网络性能测试。
